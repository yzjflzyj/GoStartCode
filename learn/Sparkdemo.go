...
var (
	...
	//hostUrl   = "wss://spark-api.xf-yun.com/v1.1/chat"  //星火大模型V1.5请求地址，对应的domain参数为general：
	//hostUrl   = "wss://spark-api.xf-yun.com/v2.1/chat" //星火大模型V2请求地址，对应的domain参数为generalv2：
	appid     = "be13734d"
	apiSecret = "NjNjMTYwMmRjNWMzZGQ4YzJhOWIwMzUx"
	apiKey    = "5df6dc5ab1b5272922b727a1479cf9a8"
)
...
func main() {
	...
	go func() {
		...
		data := genParams(appid, "leetcode:go实现两数之和")
		conn.WriteJSON(data)
